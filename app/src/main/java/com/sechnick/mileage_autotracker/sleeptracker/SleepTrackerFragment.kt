...
import com.sechnick.mileage_autotracker.databinding.FragmentSleepTrackerBinding
...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        sleepTrackerViewModel.trips.observe(viewLifecycleOwner, Observer {
            it?.let {
        ...
        sleepTrackerViewModel.navigateToSleepQuality.observe(this, Observer { trip ->
            trip?.let {
